...
def initialize_uwpjs():
    ...
    print(Fore.GREEN + "🚀 Downloading Capacitor Xbox template...")
    ...
    print(Fore.GREEN + "🔧 Extracting Capacitor Xbox template...")
    ...
    print(Fore.GREEN + "✅ Initialization complete! Run sync next to prepare your Capacitor Xbox project.")
...
def sync_project():
    ...
    print(Fore.GREEN + f"✅ Sync complete! Your Capacitor Xbox project '{project_name}' is now up-to-date.")
...
def main():
    ...
    if cmd in ["init", "-i"]:
        if os.path.exists("uwp_js.config.json"):
            print(Fore.RED + "❌ Capacitor Xbox already initialized. exiting...")
            sys.exit(1)

        if os.path.exists("uwp"):
            print(Fore.RED + "❌ Capacitor Xbox already exists. Please remove it first. exiting...")
            sys.exit(1)
        print(Fore.BLUE + "🔧 Initializing Capacitor Xbox project...")
        initialize_uwpjs()

    elif cmd in ["sync", "-s"]:
        if not os.path.exists("uwp_js.config.json"):
            print(Fore.RED + "❌ Capacitor Xbox project not initialized. exiting...")
            sys.exit(1)
        print(Fore.BLUE + "🔄 Syncing Capacitor Xbox project...")
